    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href=""><i class="la la-mouse-pointer"></i><span
                        class="menu-title" data-i18n="nav.add_on_drag_drop.main">لغات الموقع </span></a>
            </li>

            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">  {{-- {{$Language->count()}} --}} </span>

                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">error {{-- {{App\Models\Language::count()}} --}}</span>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{-- {{App\Models\maincategories::defaultCategory() ->count()}} --}} error</span>
                </a>
