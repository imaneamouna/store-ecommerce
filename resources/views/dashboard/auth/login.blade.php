...
@section('content')
imane a software engineer
i am study in hama lakhdar university in eloued/algeria
@stop --}}
@extends('layouts.login')
@section('title', 'الدخول'){{-- the title of the page --}}
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{ route('admin.post.login') }}"
                                ...
                                {{-- csrf token it is an middelware --}}
                                @csrf
